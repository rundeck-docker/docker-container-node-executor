...
# Created: Tue Jul 28 10:46:24 PDT 2015
#
#/ usage: docker-container-node-executor:dispatch  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}> [ --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>]  --command <>  --container <> 
